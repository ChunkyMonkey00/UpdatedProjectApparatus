...
public class Reflector
{
    ...
    T GetField<T>(string variableName, BindingFlags flags)
    {
        ...
        {
            throw new InvalidOperationException($"Could not cast field '{variableName}' to type '{typeof(T)}'.");
        }
    }
    ...
    T GetProperty<T>(string propertyName, BindingFlags flags)
    {
        ...
        {
            throw new InvalidOperationException($"Could not cast property '{propertyName}' to type '{typeof(T)}'.");
        }
    }
    ...
    Reflector SetField(string variableName, object value, BindingFlags flags)
    {
        ...
        {
            throw new InvalidOperationException($"Could not set field '{variableName}'.");
        }
    }
    ...
    Reflector SetProperty(string propertyName, object value, BindingFlags flags)
    {
        ...
        {
            throw new InvalidOperationException($"Could not set property '{propertyName}'.");
        }
    }
    ...
    T InvokeMethod<T>(string methodName, BindingFlags flags, params object[] args)
    {
        ...
        {
            throw new InvalidOperationException($"Could not cast return value of method '{methodName}' to type '{typeof(T)}'.");
        }
    }
